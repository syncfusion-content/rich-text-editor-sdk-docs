...
new Vue({
	...
	template: `
    <div>
        <ejs-richtexteditor id="mention_integration"  placeholder="Type @ and tag the name" :actionBegin="onActionBegin" :iframeSettings="iframeSettings" :created="created">
        </ejs-richtexteditor>
        <div v-if="renderMentionComponent">
        <ejs-mention id="mentionEditor" :target="mentionTarget" :suggestionCount="8" :showMentionChar="false" :allowSpaces="true" :dataSource="data" :fields="fieldsData" popupWidth='250px' popupHeight='200px' :itemTemplate="'iTemplate'" :displayTemplate="'dTemplate'">
