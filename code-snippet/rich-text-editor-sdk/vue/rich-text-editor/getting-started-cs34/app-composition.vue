        ...
        <div class="control-section">
            <div class="sample-container">
                <div class="default-section">
                    <ejs-richtexteditor ref="rteObj" :value="rteValue" :insertVideoSettings="insertVideoSettings"> 
                    </ejs-richtexteditor>
                </div>
            </div>
        </div>
...
import { RichTextEditorComponent as EjsRichtexteditor, Toolbar, Video, Link, HtmlEditor, QuickToolbar} from "@syncfusion/ej2-vue-richtexteditor";
...
provide('richtexteditor', [Toolbar, Video, Link, HtmlEditor, QuickToolbar]);
</script>
