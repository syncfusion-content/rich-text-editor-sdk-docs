    ...
    <div>
        <div class="control-section">
            <div class="sample-container">
                ...
                <ejs-richtexteditor ref="rteObj" :quickToolbarSettings="quickToolbarSettings" :value="rteValue" :height="340" :toolbarSettings="toolbarSettings" :value="rteValue"></ejs-richtexteditor>
                </div>
            </div>
        </div>
    </div>
...
import { RichTextEditorComponent, Toolbar, Link, Image, Audio, Video, HtmlEditor, QuickToolbar, Table } from "@syncfusion/ej2-vue-richtexteditor";
...
export default {
    ...
    provide:{
        richtexteditor:[Toolbar, Link, Image, Audio, Video, HtmlEditor, QuickToolbar, Table]
    }
}
</script>
<style>
