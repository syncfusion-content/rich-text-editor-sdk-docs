...
new Vue({
	el: '#app',
	template: `<ejs-richtexteditor ref="defaultRTE" :height="340" :value="rteValue" :UndoRedoSteps="50" :UndoRedoTimer="400"></ejs-richtexteditor> <br> <button @click="clearUndoRedoStack" style="margin-top: 16px;">Clear Undo/Redo Stack</button>`,
    ...
    methods: {
    clearUndoRedoStack() {
      const contentElement = this.$refs.defaultRTE.ej2Instances;
