...
import { RichTextEditorComponent as EjsRichtexteditor, Toolbar, Link, Image, HtmlEditor, QuickToolbar, AutoFormat } from '@syncfusion/ej2-vue-richtexteditor';

const rteValue = `<h3>Markdown Auto-Format</h3>
...
provide('richtexteditor',  [Toolbar, Link, Image, HtmlEditor, QuickToolbar, AutoFormat]);
</script>
