<template>
  <ejs-richtexteditor ref="defaultRTE" :height="350" :value="rteValue"></ejs-richtexteditor>
</template>

<script>
import { RichTextEditorComponent, Toolbar, Link, Image, HtmlEditor, QuickToolbar, AutoFormat } from '@syncfusion/ej2-vue-richtexteditor';
export default {
  name: "App",
  components: {
