<template>
  <ejs-richtexteditor ref="defaultRTE" :height="340" :value="rteValue" :toolbarSettings="toolbarSettings" :lineHeight="lineHeight"></ejs-richtexteditor>
</template>
