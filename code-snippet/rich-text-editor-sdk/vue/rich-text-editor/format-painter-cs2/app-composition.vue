    ...
    <div>
        <div class="control-section">
            <div class="sample-container">
                ...
                <ejs-richtexteditor ref="rteObj" :formatPainterSettings="formatPainterSettings" :toolbarSettings="toolbarSettings" :value="rteValue" ></ejs-richtexteditor>
                </div>
            </div>
        </div>
    </div>
