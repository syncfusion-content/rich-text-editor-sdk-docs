...
new Vue({
    ...
    <div class="control-section">
        <div class="sample-container">
            ...
            <ejs-richtexteditor ref="rteObj" :value="rteValue" :formatPainterSettings="formatPainterSettings" :toolbarSettings="toolbarSettings" ></ejs-richtexteditor>
            </div>
        </div>
    </div>
</div>`,
    ...
    provide:{
        richtexteditor:[Toolbar, Link, Image, HtmlEditor, QuickToolbar, FormatPainter]
    }
});