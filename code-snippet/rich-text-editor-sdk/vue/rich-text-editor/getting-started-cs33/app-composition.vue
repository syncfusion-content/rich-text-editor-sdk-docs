        ...
        <div class="control-section">
            <div class="sample-container">
                <div class="default-section">
                    <ejs-richtexteditor ref="rteObj" :value="rteValue" :insertAudioSettings="insertAudioSettings"> 
                    </ejs-richtexteditor>
                </div>
            </div>
        </div>
...
import { RichTextEditorComponent as EjsRichtexteditor, Toolbar, Audio, Link, HtmlEditor, QuickToolbar} from "@syncfusion/ej2-vue-richtexteditor";
...
provide('richtexteditor', [Toolbar, Audio, Link, HtmlEditor, QuickToolbar]);
</script>
