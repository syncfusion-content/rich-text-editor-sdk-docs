<template>
  <ejs-richtexteditor ref="defaultRTE" :height="340" :value="rteValue" :toolbarSettings="toolbarData" :inlineMode="inlineModeData"></ejs-richtexteditor>
</template>
