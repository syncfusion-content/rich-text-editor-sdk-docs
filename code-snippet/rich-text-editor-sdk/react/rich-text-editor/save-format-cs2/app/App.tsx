...
function App(){
  ...
  let imageSettingsModel: ImageSettingsModel = {
    saveFormat: 'Base64'
  }

  return (
    <RichTextEditorComponent height={450} insertImageSettings={imageSettingsModel} value={rteValue} toolbarSettings={toolbarSettings}>
