...
function App() {
  ...
  return (
    <RichTextEditorComponent toolbarSettings={toolbarSettings} value={rteValue} formatPainterSettings={formatPainterSettings} >
