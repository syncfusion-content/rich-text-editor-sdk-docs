System.config({
  ...
  meta: {
    ...
    '*.tsx': { loader: 'ts' },           // Critical for .tsx files
    'react': { exports: 'React' },       // Attach React to window
    'react-dom': { exports: 'ReactDOM' } // Attach ReactDOM to window
  },
