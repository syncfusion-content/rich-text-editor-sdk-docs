import { HtmlEditor, Image, Inject, Link, QuickToolbar, RichTextEditorComponent, Table, Toolbar, QuickToolbarSettingsModel } from '@syncfusion/ej2-react-richtexteditor';
...
function App() {
  ...
  return (
    <RichTextEditorComponent height={450} value={rteValue} toolbarSettings={toolbarSettings} quickToolbarSettings={quickToolbarSettings} width='250px'>
