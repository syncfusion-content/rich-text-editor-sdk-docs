...
class App extends React.Component<{},{}> {
  ...
  private rteValue: string = `<h3>Markdown Auto-Format</h3>
  ...
  public render() {
    return (
          <RichTextEditorComponent value={this.rteValue} id='editor'>
              <Inject services={[HtmlEditor, Toolbar, Image, Link, QuickToolbar, AutoFormat]} />
