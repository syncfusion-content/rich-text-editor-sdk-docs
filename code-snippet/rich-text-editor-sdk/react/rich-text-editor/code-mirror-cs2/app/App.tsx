...
function App() {
  ...
  return (
    <RichTextEditorComponent ref={(richtexteditor) => { rteObj = richtexteditor! }} height={450} toolbarSettings={toolbarSettings} showCharCount={true} actionComplete={actionComplete =actionComplete.bind(this) } created={created = created.bind(this)}>
