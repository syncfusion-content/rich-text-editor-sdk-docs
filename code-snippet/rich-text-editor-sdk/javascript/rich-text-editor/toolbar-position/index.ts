import { RichTextEditor, Toolbar, HtmlEditor,  Image, Table, Link, ToolbarPosition, QuickToolbar, PasteCleanup } from '@syncfusion/ej2-richtexteditor';

RichTextEditor.Inject(Toolbar, HtmlEditor, Image, Table, Link, QuickToolbar, PasteCleanup);
