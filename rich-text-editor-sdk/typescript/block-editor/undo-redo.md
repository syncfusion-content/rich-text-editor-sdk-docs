...
The Block Editor stores a history of actions, allowing users to perform undo and redo operations. By default, it saves up to `30` actions. You can control this limit using the [undoRedoStack](https://ej2.syncfusion.com/documentation/api/blockeditor/index-default#undoredostack) property.
