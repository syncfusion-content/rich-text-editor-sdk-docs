...
To use the Slash command feature, inject the Slash command module using `RichTextEditor.Inject(SlashMenu)`.
...
This list can include various formatting options such as paragraph and heading levels. Here is a code snippet for configuring the Slash command items:
