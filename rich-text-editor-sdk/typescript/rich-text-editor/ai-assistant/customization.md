...
# Customization of AI Assistant in TypeScript Rich Text Editor

> **Version Compatibility**: The AI Assistant feature is available from Syncfusion v32.1.19 and later. Requires TypeScript 3.x+, @syncfusion/ej2-richtexteditor v32.1.19, and an AI service endpoint configured with a valid API key.
