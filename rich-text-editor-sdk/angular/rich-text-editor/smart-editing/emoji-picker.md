...
description: Learn how to add emojis in the Angular Rich Text Editor with search, categories, keyboard support, and a better content creation experience.
...
## Add the Emoji Picker tool to the toolbar
...
You can also enhance the user experience by implementing a filtering feature to manage a large dataset of emojis. By setting the [showSearchBox](https://helpej2.syncfusion.com/angular/documentation/api/rich-text-editor/emojisettingsmodel#showsearchbox) property to `true` (default), users can use a search box to filter the displayed emojis according to their preferences.
...
### Open the Emoji Picker with shortcut keys

Quickly access the Emoji Picker by pressing the colon (`:`) key while typing a word prefix in the editor, allowing instant emoji selection and display. Continue typing in the editor after the colon (`:`) to filter and refine your search for the desired emojis.

![Angular Rich Text Editor Emoji Picker](../images/angular-richtexteditor-emoji-picker-web.png)

## Navigate and select emojis with the keyboard
...
* **Enter**: Press <kbd>Enter</kbd> to select the currently focused emoji.
* **Escape**: Press <kbd>Escape</kbd> to close the emoji picker popup without selecting an emoji.