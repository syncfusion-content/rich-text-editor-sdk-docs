---
layout: post
title: Slash Menu in Angular Rich Text Editor | Syncfusion
description: Learn how to use the Slash Menu in the Angular Rich Text Editor to apply formatting, insert elements, and execute custom commands by typing the slash character.
...
# Slash Menu in Angular Rich Text Editor
