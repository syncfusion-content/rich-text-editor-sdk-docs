---
layout: post
title: XHTML Validation in Angular Rich Text Editor | Syncfusion
description: Learn how to enable XHTML validation and XSS prevention in the Angular Rich Text Editor using the enableXhtml and enableHtmlSanitizer settings.
