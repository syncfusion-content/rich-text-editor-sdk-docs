---
layout: post
title: Code Blocks in Angular Rich Text Editor | Syncfusion
description: Learn how to insert and configure code blocks in the Angular Rich Text Editor with language selection, formatting options, and syntax highlighting support.
...
{% include code-snippet/rich-text-editor-sdk/angular/rich-text-editor/code-block-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/rich-text-editor-sdk/angular/rich-text-editor/code-block-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/samples/rich-text-editor-sdk/angular/rich-text-editor/code-block-cs1" %}
