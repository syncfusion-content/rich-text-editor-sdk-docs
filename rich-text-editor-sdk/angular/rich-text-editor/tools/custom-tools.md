---
layout: post
title: Custom Toolbar in Angular Rich Text Editor | Syncfusion
description: Learn how to create and add custom toolbar commands in the Angular Rich Text Editor using the toolbarSettings property with text, icon, or HTML templates.
...
# Custom Toolbar in Angular Rich Text Editor
