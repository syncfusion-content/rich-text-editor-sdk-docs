...
description: Learn how to use Fullscreen mode in the Angular Rich Text Editor to expand the editor to the full browser viewport for distraction-free editing.
