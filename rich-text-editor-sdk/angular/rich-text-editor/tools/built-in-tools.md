---
layout: post
title: Toolbar Items in Angular Rich Text Editor | Syncfusion
description:  Learn about all available toolbar items in Angular Rich Text Editor, including text formatting, images, tables, links, lists, quick toolbars, and customization.
...
The Angular Rich Text Editor's toolbar provides tools for formatting, styling, and managing content, enhancing user productivity in a Rich Text Editor.
