...
The Syncfusion Angular Headless Editor component is a powerful rich text editing solution that provides an framework-integrated way to create and manage editable content in Angular applications.
...
All available Essential JS 2 packages are published in the [npmjs.com](https://www.npmjs.com/~syncfusionorg) registry. Install the Headless Editor component with the following command:

```bash
npm install @syncfusion/ej2-angular-headless-editor
```

## Add the CSS reference

Syncfusion provides multiple themes for the Headless Editor component. For a complete list of available themes, refer to the [themes packages](https://ej2.syncfusion.com/angular/documentation/appearance/overview#theme-packages).
...
## Add the Headless Editor component

Modify the template in the `src/app/app.ts` file to render the Headless Editor component. Add the Angular Headless Editor by using the `<ejs-headlesseditor>` selector in the `template` section of the app.ts file.
