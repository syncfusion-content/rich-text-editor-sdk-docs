---
layout: post
title: Mentions in Angular Markdown Editor | Syncfusion
description: Learn how to enable mentions in the Angular Markdown Editor using the @ trigger to tag users or items from a suggestion list while editing Markdown content.
