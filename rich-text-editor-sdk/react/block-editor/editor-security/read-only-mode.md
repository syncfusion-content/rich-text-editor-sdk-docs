...
The Syncfusion React Block Editor provides a read-only mode to control user interaction with the editor. This allows users to view formatted content without editing capability. Read-only mode is useful for displaying published content, archived documents, or preventing accidental modifications during review or approval workflows.
