---
layout: post
title: Syncfusion Rich Text Editor SDK Themes
...
- [Overview](overview.md) — the Rich Text Editor SDK’s editors, supported platforms, and feature summary.
- [Accessibility](#) — accessibility features, ARIA support, and the High Contrast theme.
- [Globalization / Localization](#) — locale and RTL considerations, which interact with the theme’s typography and directionality tokens.
- [Release Notes](Release-Notes/) — track theme additions, deprecations, and improvements across versions.
