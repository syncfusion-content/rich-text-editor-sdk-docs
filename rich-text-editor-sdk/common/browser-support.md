...
The Syncfusion<sup style="font-size:70%">&reg;</sup> React Rich Text Editor SDK (`@syncfusion/ej2-react-richtexteditor`) is supported in all modern browsers. The following table lists the supported browser families for the React Rich Text Editor, Block Editor, and Markdown Editor components.
