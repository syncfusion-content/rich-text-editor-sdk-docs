...
- Right-to-Left (RTL) layout support (see [Right-to-Left support](./right-to-left))
...
Built-in RTL rendering for languages such as Arabic, Hebrew, and Persian. See [Right-to-Left support](./right-to-left).
