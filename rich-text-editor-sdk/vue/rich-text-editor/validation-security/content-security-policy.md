...
# Content Security Policy (CSP) in Vue Rich Text Editor
...
<script>
import { RichTextEditorComponent, Toolbar, HtmlEditor, QuickToolbar } from '@syncfusion/ej2-vue-richtexteditor';
...
export default {
  ...
  provide: {
    richtexteditor: [Toolbar, HtmlEditor, QuickToolbar]
  }
};
</script>
```
...
> IMPORTANT
>
> When using a strict `script-src` policy, generate the Vue build with `npm run build` and serve the static assets from the same origin as the application. Use hashed or nonce-based script attributes to allow runtime-injected inline scripts.
...
> NOTE
>
> For additional guidance on resolving CSP errors in Syncfusion EJ2 controls, refer to the [Resolve CSP errors in EJ2 Vue Common control](https://ej2.syncfusion.com/vue/documentation/common/how-to/csp-errors) documentation.
...
* [Security Considerations in EJ2 Vue Common control](https://ej2.syncfusion.com/vue/documentation/common/security#security-considerations)
* [Resolve CSP errors in EJ2 Vue Common control](https://ej2.syncfusion.com/vue/documentation/common/how-to/csp-errors)
