...
The Block Editor stores a history of actions, allowing users to perform undo and redo operations. By default, it saves up to `30` actions. You can customize this limit using the [undoRedoStack](https://ej2.syncfusion.com/vue/documentation/api/blockeditor#undoredostack) property to control the maximum number of steps that can be undone or redone.
