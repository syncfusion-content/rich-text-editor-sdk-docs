...
description: Learn how to get started with the Blazor Smart Rich Text Editor in a Blazor Server App using Visual Studio, VS Code, or the .NET CLI.
platform: Blazor
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Smart Rich Text Editor functionality.
