---
layout: post
title: Supported Markdown Syntax in Blazor Markdown Editor | Syncfusion
description: Learn about the Markdown syntax commands supported by the Blazor Markdown Editor, covering text formatting, lists, links, tables, and more.
platform: rich-text-editor-sdk
control: Markdown Editor
documentation: ug
---

# Supported Markdown Syntax in Blazor Markdown Editor
