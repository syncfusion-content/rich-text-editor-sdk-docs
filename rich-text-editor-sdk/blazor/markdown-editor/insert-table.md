---
layout: post
title: Insert Table in Blazor Markdown Editor | Syncfusion
description: Learn how to insert and customize tables in the Blazor Markdown Editor by adding the CreateTable option to the toolbar items.
platform: rich-text-editor-sdk
control: Markdown Editor
documentation: ug
---

# Insert Table in Blazor Markdown Editor
