...
description: Learn how to customize Markdown syntax in the Blazor Markdown Editor by overriding the default Markdown formatter with custom list, format, and selection options.
platform: rich-text-editor-sdk
control: Markdown Editor
documentation: ug
---

# Customize Markdown Syntax in Blazor Markdown Editor
