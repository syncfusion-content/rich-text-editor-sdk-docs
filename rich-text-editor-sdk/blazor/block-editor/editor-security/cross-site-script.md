...
description: Learn how the Blazor Block Editor prevents cross-site scripting (XSS) attacks through built-in HTML sanitization that removes dangerous elements and attributes.
