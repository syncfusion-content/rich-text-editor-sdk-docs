---
layout: post
title: Embed in Blazor Block Editor | Syncfusion
description: Learn how to add embed blocks in the Blazor Block Editor to organize and showcase visual content from external sources.
platform: rich-text-editor-sdk
control: Block Editor
documentation: ug
---

# Embed in Blazor Block Editor
