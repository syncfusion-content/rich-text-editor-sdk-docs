...
description: Learn how to get started with the Syncfusion Blazor Block Editor in a Blazor Web App using Visual Studio, VS Code, or the .NET CLI with setup and examples.
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Block Editor functionality.
