...
description: Learn how to get started with the Blazor Block Editor in a Blazor WebAssembly App using Visual Studio, VS Code, or the .NET CLI.
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **~wwwroot/index.html** file to enable Block Editor functionality.
