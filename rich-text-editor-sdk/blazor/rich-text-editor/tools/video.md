---
layout: post
title: Video in Blazor Rich Text Editor | Syncfusion
description: Learn how to insert and manage videos in the Blazor Rich Text Editor from online sources and local machines using RichTextEditorVideoSettings.
platform: rich-text-editor-sdk
control: Rich Text Editor
documentation: ug
---

# Video in Blazor Rich Text Editor
...
![Blazor RichTextEditor web video replace](../images/blazor-richtexteditor-video-replace-web.webp)
...
![Blazor RichTextEditor video dimension](../images/blazor-richtexteditor-video-size.webp)
...
![Blazor RichTextEditor video resize](../images/blazor-richtexteditor-video-resize.webp)
