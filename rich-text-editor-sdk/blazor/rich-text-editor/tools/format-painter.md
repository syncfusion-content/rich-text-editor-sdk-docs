...
description: Learn how to use the Blazor Rich Text Editor Format Painter to copy and apply formatting, customize allowed and denied formats, and use shortcuts.
