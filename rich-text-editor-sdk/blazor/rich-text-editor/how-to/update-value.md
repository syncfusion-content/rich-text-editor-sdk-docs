---
layout: post
title: Update Value in Blazor Rich Text Editor | Syncfusion
description: Learn how to update the value in the Blazor Rich Text Editor by binding a keydown event to the editor's div element to capture Ctrl+S.
platform: rich-text-editor-sdk
control: Rich Text Editor
documentation: ug
---

# Update Value in Blazor Rich Text Editor
...
<div class="control-section" onkeydown=@onKeyDown>
    <SfRichTextEditor ID="richTextEditor" @ref="editor" SaveInterval="1" @bind-Value="@editorValue" >
...
@code {
    ...
    public async Task onKeyDown(KeyboardEventArgs arg)
    {
        ...
        {
             this.editorValue =  await this.editor.GetXhtmlAsync();
        }
    }
