---
layout: post
title: Rich Text Editor in a Dialog in Blazor | Syncfusion
description: Learn how to render the Blazor Rich Text Editor inside a Dialog component and call RefreshUIAsync in the Dialog Opened event to fix toolbar offset.
platform: rich-text-editor-sdk
control: Rich Text Editor
documentation: ug
---

# Rich Text Editor in a Dialog in Blazor
