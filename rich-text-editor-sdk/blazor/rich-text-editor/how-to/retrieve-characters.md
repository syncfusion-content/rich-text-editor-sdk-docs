---
layout: post
title: Get Character Count in Blazor Rich Text Editor | Syncfusion
description: Learn how to retrieve the character count in the Blazor Rich Text Editor using the GetCharCount method.
