---
layout: post
title: Table in Blazor Rich Text Editor | Syncfusion
description: Learn how to insert, format, and manage tables in the Blazor Rich Text Editor using RichTextEditorTableSettings for rows, columns, and styles.
platform: rich-text-editor-sdk
control: Rich Text Editor
documentation: ug
---

# Table in Blazor Rich Text Editor
