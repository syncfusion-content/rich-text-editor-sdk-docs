...
description: Learn how to get started with the Blazor Rich Text Editor in Blazor Web App and explore setup, configuration, and core feature examples.
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Blazor Rich Text Editor  functionality.
