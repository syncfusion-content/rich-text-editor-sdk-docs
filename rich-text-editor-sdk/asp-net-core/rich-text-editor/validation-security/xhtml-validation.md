---
layout: post
title: XHTML Validation and XSS Prevention in ASP.NET Core Rich Text Editor | Syncfusion
description: Learn how to validate XHTML content and prevent XSS attacks in the ASP.NET Core Rich Text Editor using built-in sanitization and custom filtering.
...
# XHTML Validation and XSS Prevention in ASP.NET Core Rich Text Editor
