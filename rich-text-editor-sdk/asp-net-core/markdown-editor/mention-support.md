...
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/markdown-mention-support/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Mention.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/markdown-mention-support/mention.cs %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/markdown-mention-support/controller.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/markdown-mention-support/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Mention.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/markdown-mention-support/mention.cs %}
{% endhighlight %}
