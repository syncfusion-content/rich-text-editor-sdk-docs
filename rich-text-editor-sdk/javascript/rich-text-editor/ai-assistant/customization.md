...
> **Version Compatibility**: The AI Assistant feature is available from Syncfusion v32.1.19 and later. Requires the corresponding Syncfusion JavaScript Rich Text Editor package v32.1.19, and an AI service endpoint configured with a valid API key.
