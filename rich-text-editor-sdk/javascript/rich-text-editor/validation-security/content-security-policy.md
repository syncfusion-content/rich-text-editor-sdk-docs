...
description: Learn how to configure Content Security Policy directives for the JavaScript Rich Text Editor to enable CSP-compliant applications.
...
The following example shows a recommended Content Security Policy configuration for a JavaScript application that hosts the Rich Text Editor:
...
> NOTE
>
> The editor initialization code is placed in an external JavaScript file (`index.js`) to comply with strict `script-src` policies.
