...
The following example shows a recommended Content Security Policy configuration for a JavaScript application that hosts the Syncfusion Rich Text Editor:
