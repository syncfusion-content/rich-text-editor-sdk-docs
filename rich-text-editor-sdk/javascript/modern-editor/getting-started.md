---
layout: post
title: Getting Started with JavaScript Modern Editor | Syncfusion
description: Learn how to get started with the JavaScript Modern Editor and explore setup, configuration, and core feature examples.
platform: rich-text-editor-sdk
control: Modern Editor
documentation: ug
domainurl: https://help.syncfusion.com/rich-text-editor-sdk/
---

# Getting started in JavaScript Modern Editor
...
The following list of dependencies are required to use the `Modern Editor` control in the application.
...
**Step 3:** Open Visual Studio Code and create `my-app/index.js` and `my-app/index.html` files for initializing the Essential JS 2 Modern Editor control.

## Adding Modern Editor styles
...
I> Ensure that all Modern Editor script files are loaded in the correct order and included before initializing the control. The order is important because the scripts have dependencies, and loading them incorrectly may prevent the Modern Editor from working properly or cause runtime errors. Make sure the required base and dependent scripts are included along with the Modern Editor script.

## Adding Modern Editor control

Add the Modern Editor control to the application as follows. Place the target element in **index.html** and the initialization code in **index.js** using the sample below.

> Add a target element such as `<div id="editor"></div>` in `index.html` before calling `appendTo` in `index.js`.

The Modern Editor can be initialized on a `div` element, as shown below:
...
The Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Modern Editor is displayed as shown below.

![Syncfusion JavaScript Modern Editor output](images/getting-started.png)

## See Also

**Live examples:**

* `Syncfusion JavaScript Modern Editor demos`

N> You can refer to our `JavaScript Modern Editor` feature tour page for its groundbreaking feature representations. You can also explore our `JavaScript Modern Editor example` that shows how to render the modern editor tools.
