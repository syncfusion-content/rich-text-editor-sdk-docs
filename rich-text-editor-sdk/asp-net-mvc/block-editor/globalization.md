...
description: Learn how to localize the ASP.NET MVC Block Editor with localization, right-to-left (RTL) support, and translated UI text for global applications.
...
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/block-editor/globalization/locale/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Locale.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/block-editor/globalization/locale/locale.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/block-editor/globalization/rtl/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Rtl.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/block-editor/globalization/rtl/rtl.cs %}
{% endhighlight %}
{% endtabs %}
