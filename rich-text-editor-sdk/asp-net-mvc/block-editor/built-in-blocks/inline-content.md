...
# Inline Content in ASP.NET MVC Block Editor
...
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/block-editor/blocks/label-settings/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/block-editor/blocks/label-settings/label.cs %}
{% endhighlight %}
{% endtabs %}
