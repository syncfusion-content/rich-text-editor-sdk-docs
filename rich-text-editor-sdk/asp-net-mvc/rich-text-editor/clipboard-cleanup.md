...
description: Learn how to clean clipboard content in the ASP.NET MVC Rich Text Editor by removing unwanted styles and preserving formatting during copy and cut.
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/rich-text-editor/clipboard-cleanup-customize/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/rich-text-editor/clipboard-cleanup-customize/controller.cs %}
{% endhighlight %}
