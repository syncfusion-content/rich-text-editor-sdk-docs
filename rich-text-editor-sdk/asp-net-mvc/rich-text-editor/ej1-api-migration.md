---
layout: post
title: Migrate Essential JS 1 Rich Text Editor to ASP.NET MVC | Syncfusion
description: Learn how to migrate from Essential JS 1 to the ASP.NET MVC Rich Text Editor by mapping APIs, features, and configuration settings.
...
# Migrate Essential JS 1 Rich Text Editor to ASP.NET MVC
