---
layout: post
title: Quotation Formatting in ASP.NET MVC Rich Text Editor | Syncfusion
description: Learn how to apply quotation formatting in the ASP.NET MVC Rich Text Editor to highlight quoted content and improve readability.
control: Rich Text Editor
platform: rich-text-editor-sdk
documentation: ug
---

# Quotation Formatting in ASP.NET MVC Rich Text Editor
