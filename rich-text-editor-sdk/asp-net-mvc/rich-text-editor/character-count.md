---
layout: post
title: Character Count in ASP.NET MVC Rich Text Editor | Syncfusion
description: Learn how to enable and display character count in the ASP.NET MVC Rich Text Editor to monitor and manage content length effectively.
control: Rich Text Editor
platform: rich-text-editor-sdk
documentation: ug
---

# Character Count in ASP.NET MVC Rich Text Editor
