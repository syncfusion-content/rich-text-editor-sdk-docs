---
layout: post
title: AI Assistant Customization in ASP.NET MVC Rich Text Editor | Syncfusion
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-mvc/rich-text-editor/ai-assistant/popup-styling/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
